...
files = list.files("F:/CESM_Output/16_09_2015/h1/2010", pattern=".nc", all.files=T, full.names=T)

# output directory
setwd("F:/CESM_Output/16_09_2015/h1/2010")
...
ncout1 <- create.ncdf(paste ("2T_",i,".nc", sep = "", collapse = NULL), sm1)
put.var.ncdf(ncout1, sm1, data1)
close.ncdf(ncout1)
